...
class FlutterPusher {
  static const MethodChannel _channel =
      const MethodChannel('com.github.rawezhit/pusher');
  final EventChannel _eventChannel =
      const EventChannel('com.github.rawezhit/pusherStream');
  static int _instances = 0;

  late int _instanceId;
  late String _socketId;
  final Map<String, Function> _eventCallbacks = Map<String, Function>();
  ...
  void _handleEvent([dynamic arguments]) async {
    ...
    if (message.isEvent) {
      ...
      if (_onError != null) {
        _onError(message.connectionError as ConnectionError);
      }
    }
  }
